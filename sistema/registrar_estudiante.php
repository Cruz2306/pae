...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre1'])  || empty($_POST['apellido1']) || empty($_POST['apellido2']) || empty($_POST['idEstudiante'])) {
        ...
        $query_insert = mysqli_query($conexion, "INSERT INTO estudiante (idEstudiante,documento,nombre1,nombre2,apellido1,apellido2,grado,jornada,id_sede)VALUES($idEstudiante,'$tipo_documento','$nombre1',
            '$nombre2','$apellido1','$apellido2',$grado,'$jornada','$id_sede')");

        //  $consulta = mysqli_query($conexion, "INSERT INTO estudiante (idEstudiante,documento,nombre1,nombre2,apellido1,apellido2,grado,jornada,id_sede)VALUES($idEstudiante,'$tipo_documento','$nombre1',
        //  '$nombre2','$apellido1','$apellido2',$grado,'$jornada','$id_sede')");
